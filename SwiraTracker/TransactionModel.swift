...
extension Category{
    ...
    static let grocries = Category(id: 501, name: "Grocries", icon: .shopping_basket, mainCategoryId: 5)
    ...
    static let paycheqe = Category(id: 701, name: "Paycheqe", icon: .dollar_sign, mainCategoryId: 7)
    static let sofware = Category(id: 801, name: "Sofware", icon: .icons, mainCategoryId: 8)
